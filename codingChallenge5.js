...
HINT: Loop over the array, and in each iteration store the current sum in a variable (starting from 0). After you have the sum of the array, divide it by the number of elements in it 
...
var averageJohn = averageTips(johnBills.tips);
var averageMark = averageTips(markBills.tips);

if (averageJohn > averageMark) {
  console.log("John paid more bills on average: " + averageJohn);
} else if (averageMark > averageJohn) {
  console.log("Mark paid more bills on average: " + averageMark);
}
